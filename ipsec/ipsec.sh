...
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Kebenaran diterima...${NC}"
else
echo -e "${NC}${RED}Kebenaran ditolak!${NC}";
echo -e "${NC}${LIGHT}Fuck awak!!"
exit 0
fi
# ==================================================
# Link Hosting Kalian
...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /var/lib/crot/data-user-l2tp "https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/l2tp-user.sh"
wget -O /var/lib/crot/data-user-pptp "https://raw.githubusercontent.com/wayangkulit95/siakap/momok/ipsec/pptp-user"
