...
#Pasang skrip WebSocket-SSH Python
...
wget -O /usr/local/bin/ws-dropbear https://raw.githubusercontent.com/wayangkulit95/siakap/momok/Insshws/dropbear-ws.py.txt
wget -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/wayangkulit95/siakap/momok/Insshws/ws-stunnel.txt
...
#Sistem dropbear websocket-ssh python
...
#Sistem Dropbear WebSocket-SSH Python
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/wayangkulit95/siakap/momok/Insshws/service-wsdropbear.txt && chmod +x /etc/systemd/system/ws-dropbear.service

#Sistem SSL/TLS WebSocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/wayangkulit95/siakap/momok/Insshws/ws-stunnel.service.txt && chmod +x /etc/systemd/system/ws-stunnel.service
...
#Dayakan & Mula & Mulakan semula Perkhidmatan WS-Dropbear
systemctl enable ws-dropbear.service
systemctl start ws-dropbear.service
systemctl restart ws-dropbear.service

#Dayakan dan Mulakan & Mulakan semula Perkhidmatan WSL-Openssh
